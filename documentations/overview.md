...
- Client components call API routes under `app/api/**` to read and mutate data (including month-end cerement totals plus the cerement, commission, and sales years lists).
